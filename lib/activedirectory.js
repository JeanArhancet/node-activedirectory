...
ActiveDirectory.prototype.getRootDSE = function getRootDSE (url, attributes, callback) { // jshint -W071
  ...
  if (Object.prototype.hasOwnProperty.call((this && this.opts) ? this.opts : {}, 'tlsOptions')) {
    client.starttls(this.opts.tlsOptions, client.controls, function (err) {
      log.trace('Start TLS "%s" failed. Error: %s', url, err)
      return _cb(err)
    })
  }
